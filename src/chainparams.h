...
// Copyright (c) 2015-2017 The WBTC Core developers
// Copyright (c) 2019 The WBTC Core developers
 ...
 * WBTC system. There are three: the main network on which people trade goods
