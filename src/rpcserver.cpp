...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* WBTC features */
        {"WBTC", "masternode", &masternode, true, true, false},
        {"WBTC", "listmasternodes", &listmasternodes, true, true, false},
        {"WBTC", "getmasternodecount", &getmasternodecount, true, true, false},
        {"WBTC", "masternodeconnect", &masternodeconnect, true, true, false},
        {"WBTC", "masternodecurrent", &masternodecurrent, true, true, false},
        {"WBTC", "masternodedebug", &masternodedebug, true, true, false},
        {"WBTC", "startmasternode", &startmasternode, true, true, false},
        {"WBTC", "createmasternodekey", &createmasternodekey, true, true, false},
        {"WBTC", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"WBTC", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"WBTC", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"WBTC", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"WBTC", "getmasternodescores", &getmasternodescores, true, true, false},
        {"WBTC", "mnbudget", &mnbudget, true, true, false},
        {"WBTC", "preparebudget", &preparebudget, true, true, false},
        {"WBTC", "submitbudget", &submitbudget, true, true, false},
        {"WBTC", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"WBTC", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"WBTC", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"WBTC", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"WBTC", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"WBTC", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"WBTC", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"WBTC", "checkbudgets", &checkbudgets, true, true, false},
        {"WBTC", "mnsync", &mnsync, true, true, false},
        {"WBTC", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> WBTC-cli " + methodname + " " + args + "\n";
}
