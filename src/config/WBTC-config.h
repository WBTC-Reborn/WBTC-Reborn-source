/* src/config/WBTC-config.h.  Generated from WBTC-config.h.in by configure.  */
/* src/config/WBTC-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef WBTC_CONFIG_H

#define WBTC_CONFIG_H
...
#define PACKAGE_NAME "WBTC Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "WBTC Core 2.0.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "WBTC"
