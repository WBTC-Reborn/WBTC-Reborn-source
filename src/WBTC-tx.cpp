...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("WBTC Core WorldBTC-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  WBTC-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded WBTC transaction") + "\n" +
                               "  WBTC-tx [options] -create [commands]   " + _("Create hex-encoded WBTC transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded WBTC transaction
