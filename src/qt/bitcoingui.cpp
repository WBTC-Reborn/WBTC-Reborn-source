                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("WBTC Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a WBTC address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and WBTC: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About WBTC Core"), this);
    aboutAction->setStatusTip(tr("Show information about WBTC Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for WBTC"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your WBTC addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified WBTC addresses"));
    ...
    openAction->setStatusTip(tr("Open a WBTC: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the WBTC Core help message to get a list with possible WBTC command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("WBTC Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to WBTC network", "", count));
}
...
{
    QString strTitle = tr("WBTC Core"); // default title
