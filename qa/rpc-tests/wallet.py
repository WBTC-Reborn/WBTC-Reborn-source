...
#   c) node1 mines 32 blocks, so now node 0 has 500000WBTC, node 1 has 4250WBTC, node2 has none.
#   d) node0 sends 601 WBTC to node2, in two transactions (301 WBTC, then 300 WBTC).
