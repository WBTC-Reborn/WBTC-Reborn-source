Contributing to WBTC Core
==================================

The WBTC Core project operates an open contributor model where anyone is
...
The following applies to code changes to the WBTC Core project, and is not to be
confused with overall WBTC Network Protocol consensus changes.

Whether a pull request is merged into WBTC Core rests with the project merge
...
Patches that change WBTC consensus rules are considerably more involved than
...
Where a patch set proposes to change the WBTC consensus, it must have been
...
The project leader is the release manager for each WBTC Core release.
