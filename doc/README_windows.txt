...
Intro
-----
WBTC (WBTC) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. WBTC utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run WBTC-qt.exe.

WBTC Core is the original WBTC client and it builds the backbone of the network.
However, it downloads and stores the entire history of WBTC transactions;
