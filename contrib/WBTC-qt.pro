...
RESOURCES += src/qt/WBTC.qrc src/qt/WBTC_locale.qrc

TRANSLATIONS += src/qt/locale/WBTC_bg.ts \
                src/qt/locale/WBTC_de.ts \
                src/qt/locale/WBTC_en.ts \
                src/qt/locale/WBTC_es.ts \
                src/qt/locale/WBTC_fi.ts \
                src/qt/locale/WBTC_fr.ts \
                src/qt/locale/WBTC_it.ts \
                src/qt/locale/WBTC_ja.ts \
                src/qt/locale/WBTC_pl.ts \
                src/qt/locale/WBTC_pt.ts \
                src/qt/locale/WBTC_ru.ts \
                src/qt/locale/WBTC_sk.ts \
                src/qt/locale/WBTC_sv.ts \
                src/qt/locale/WBTC_vi.ts \
                src/qt/locale/WBTC_zh_CN.ts \
                src/qt/locale/WBTC_zh_TW.ts
